...
function FeatureCard({title , description , icon}) {
  return (
    <>
    <div className="w-98 h-100 p-6 bg-slate-900/20 backdrop-blur-lg shadow-2xl rounded-2xl border border-gray-300 hover:shadow-[0_0_20px_rgba(34,211,238,0.6)] transition-all ease-out hover:scale-110 active:scale-50 cursor-pointer">
